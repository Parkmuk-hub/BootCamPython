...
# render_template : 문자열로 작성한 Jinja 템플릿을 렌더링 해서 HTML로 반환
...
쿠키 값 : <input type="text" name="name" placeholder="ex: hong">
...
def set_cookie() :
    ...
    return resp; # 쿠키가 포함된 응답을 브라우저로 변환
    # 브라우저는 쿠키를 저장하고, redirect 요청에 따라
    # read_cookie로 다시 요청함.
