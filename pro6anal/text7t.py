# 집단간 차이분석 :  평균 또는 비율 차리를 분석
# 모집단에서 추출한 표본정보를 이용하여 모집단의 다양한 특성을 과학적으로 추론할 수 있음
...
print(result)
# (statistic=np.float64(-0.22139444579394396), pvalue=np.float64(0.8356282194243566), df=np.int64(4))
