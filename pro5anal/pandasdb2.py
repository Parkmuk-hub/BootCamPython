...
try :
    ...
    # DataFrame으로 출력
    df1 = pd.DataFrame(rows, columns=['jikwonno','jikwonname','busername','jikwonjik','jikwongen', 'jikwonpay'])
    print(df1.head(3))
    ...
    print('부서별 인원 수 : ', df['부서'].value_counts())
    print('연봉 7000이상 : ', df.loc[df['연봉'] >= 7000])
