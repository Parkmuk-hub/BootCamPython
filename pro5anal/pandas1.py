...
obj = pd.Series([3, 7, -5, '사'])   # 요소 값은 object type
# obj = pd.Series((3, 7, -5, 4))
# obj = pd.Series({3, 7, -5, 4})  # TypeError: 'set' type is unordered
print(obj, ' ', type(obj))  # <class 'pandas.core.series.Series'>
...
print(obj2['a'])    # 3
print(obj2[['a']])  # a    3    dtype: int64

print(obj2[['a', 'b']]) # a    3 b    7 dtype: int64
print(obj2['a':'c'])    # a    3 b    7 c   -5

print(obj2[2])      # -5  # 인덱스 사용
print(obj2.iloc[2]) # -5
print(obj2[1:4])    # b    7 c   -5 d    4

print(obj2[[2, 1]])         # c   -5 b    7
print(obj2.iloc[[2, 1]])    # c   -5 b    7

print('a' in obj2)  # True
print('c' in obj2)  # True

print("파이썬 dict 자료를 Series 객체로 생성")
names = {'mouse':5000, 'keyboard':125000, 'monitor':450000}
print(names)
...
print()
print(frame['irum']) # 얘가 국룰
# print(frame.irum)
print(type(frame['irum']))

print(DataFrame(data=data, columns=['juso','irum','nai'])) # 칼럼 순서 변경가능
...
val = pd.Series(['222-2222','333-3333','444-4444'],
                index=['b','c','e'])
# print(val)
frame2['tel'] = val
print(frame2)
