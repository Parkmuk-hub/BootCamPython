# ROC(Receiver Operating Characteristic) Curve는 모든 분류 임계값에서 
# 분류 모델의 성능을 보여주는 그래프로 x축이 FPR(1-특이도), y축이 TPR(민감도)인 그래프이다. 
...
print('y_hat : ', y_hat[:5])    #  [0 1 0 1 1]
print('real : ', y[:5])        #  [0 1 0 1 1]
...
acc = (49 + 46) / 100       # TP + TN / 전체수  정확도
recall = 49 / (49 + 1)      # TP / (TP + FN)    재현율
precission = 49 / (49 + 4)  # TP / (TP + FP)    정밀도
specificity = 46 / (4 + 46)  # TN / (FP + TN)    특이도
fallout = 4 / (4 + 46)      # FP / (FP + TN)    위양성율
