...
# 독립변수 : 연속형 / 종속변수 : 연속형 - 두변 수는 상관관계 및 인과관계가 있어야함
# 정량적인 모델을 생성
...
y_pred = 89.47430739278907 * -0.67794537 + 100      # 39.34130756910188
print('예측값 : ', y_pred)
print()

xx = x
yy= y
print('방법2 : LinearRegression 사용, 모델 생성 O')
